...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 tect-center text-gray-800'>
    ...
    <h2 className='text-3xl sm:text-5xl font-semibold mb-4 '>Welcome to Department of Cyber Security</h2>
